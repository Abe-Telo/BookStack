...
return [
	...
	'shelves_navigation' => 'Categories Navigation',
    'shelves_popular_empty' => 'The most popular Categories will appear here.',
    'shelves_new_empty' => 'The most recently created Categories will appear here.',
    'shelves_save' => 'Save Category',
    'shelves_books' => 'Books on this category',
    'shelves_add_books' => 'Add books to this category',
    'shelves_drag_books' => 'Drag books here to add them to this category',
    'shelves_empty_contents' => 'This category has no books assigned to it',
    'shelves_edit_and_assign' => 'Edit category to assign books',
    ...
    'shelves_delete_explain' => "This will delete the category with the name ':name'. Contained books will not be deleted.",
    ...
    'shelves_permissions_cascade_warning' => 'Permissions on bookshelves do not automatically cascade to contained books. This is because a book can exist on multiple Categories. Permissions can however be copied down to child books using the option found below.',
    'shelves_copy_permissions_to_books' => 'Copy Permissions to Books',
    'shelves_copy_permissions' => 'Copy Permissions',
    'shelves_copy_permissions_explain' => 'This will apply the current permission settings of this category to all books contained within. Before activating, ensure any changes to the permissions of this category have been saved.',
    ...
    'tags_list_empty_hint' => 'Tags can be assigned via the page editor sidebar or while editing the details of a book, chapter or category.',
    ...
    'profile_not_created_shelves' => ':userName has not created any Categories',
